  ...
  var Buttons = function (context) {
    ...
    this.addToolbarButtons = function () {
      ...
      context.memo('button.upload', function () {
        return ui.button({
          className: "btn_upload_summernote",
          contents: ui.icon(options.icons.upload),
          tooltip: lang.upload.uploaded_img
        }).render();
      });
  ...
  $.summernote = $.extend($.summernote, {
    ...
    options: {
      ...
      toolbar: [
        ...
        ['table', ['table']],
        ['insert', ['link', 'picture', 'upload', 'video']],
