...
@section('htmlheader_title')
    @lang('la_customer.customer_view')
@endsection
...
<div id="page-content" class="profile2">
    <div class="bg-primary clearfix">
        ...
        <div class="col-md-1 actions">
            @la_access("Customers", "edit")
                <a @ajaxload href="{{ url(config('laraadmin.adminRoute') . '/customers/'.$customer->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
            @endla_access
    ...
    <ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
        <li class=""><a @ajaxload href="{{ url(config('laraadmin.adminRoute') . '/customers') }}" data-toggle="tooltip" data-placement="right" title="@lang('la_customer.back_to_customers')"><i class="fa fa-chevron-left"></i></a></li>
