...
class LAFormMaker
{
    ...
    public static function input($module, $field_name, $default_val = null, $required2 = null, $class = 'form-control', $params = [])
    {
        ...
        if (LAModule::hasFieldAccess($module->id, $module->fields[$field_name]['id'], $access_type = "write")) {
            ...
            $out .= LAFormMaker::input_field($module->id, $field_type->name, $label, $field_name, $row, $required_ast, $default_val, $defaultvalue, $params, $popup_vals, $required, $quick_add_form);
    ...
    public static function config($key)
    {
        ...
        if (isset($config->id)) {
            ...
            $out .= LAFormMaker::input_field(0, $field_type->name, $label, $field_name, $row, $required_ast, $default_val, $defaultvalue, $params, $popup_vals, $required, $quick_add_form);
     ...
     * @param boolean $display_row Whether to display bootstrap row with styles or just return Formatted Value
