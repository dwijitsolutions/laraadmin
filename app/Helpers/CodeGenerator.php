...
class CodeGenerator
{
    ...
    public static function createController($config, $comm = null)
    {
        ...
        chmod(base_path('app/Http/Controllers/LA/' . $config->controllerName . ".php"), CodeGenerator::$default_file_access);
    }
    ...
    public static function createModel($config, $comm = null)
    {
        ...
        chmod(base_path('app/Models/' . $config->modelName . ".php"), CodeGenerator::$default_file_access);
    }
    ...
    public static function createObserver($config, $comm = null)
    {
        ...
        chmod(base_path('app/Observers/' . $config->modelName . "Observer.php"), CodeGenerator::$default_file_access);
    }
    ...
    public static function appendObservers($config, $comm = null)
    {
        ...
        if (!(strpos($contents, $config->modelName) !== false)) {
            ...
            chmod($providerFile, CodeGenerator::$default_file_access);
        }
    }
    ...
    public static function createViews($config, $comm = null)
    {
        ...
        chmod(base_path('resources/views/la/' . $config->dbTableName . '/index.blade.php'), CodeGenerator::$default_file_access);
        ...
        chmod(base_path('resources/views/la/' . $config->dbTableName . '/edit.blade.php'), CodeGenerator::$default_file_access);
        ...
        chmod(base_path('resources/views/la/' . $config->dbTableName . '/show.blade.php'), CodeGenerator::$default_file_access);
    }
    ...
    public static function createLanguageFile($config, $comm = null)
    {
        ...
        chmod(base_path('resources/lang/en/' . $config->langFile . '.php'), CodeGenerator::$default_file_access);
    ...
    public static function appendRoutes($config, $comm = null)
    {
        ...
        if (!(strpos($contents, $config->controllerName) !== false)) {
            ...
            chmod($routesFile, CodeGenerator::$default_file_access);
        }
        ...
        if (!(strpos($laConfigContent, $config->singularVarUpper . "_CREATED") !== false)) {
            ...
            chmod($laConfigFile, CodeGenerator::$default_file_access);
        }
    }
    ...
    public static function generateMigration($table, $generate = false, $comm = null)
    {
        ...
        try {
            ...
            chmod(base_path('database/migrations/' . $migrationFileName), CodeGenerator::$default_file_access);
